export class AppConfig {
  ...
  public static crid_service_endpoint =
    "https://dev-internal-api.nmdp.org/cibmtrehrclientbackend/v2/CRID";

  public static cibmtr_fhir_base_url =
    "https://dev-internal-api.nmdp.org/cibmtrehrclientbackend/v2/Patient?identifier=";

  public static cibmtr_fhir_update_url =
    "https://dev-internal-api.nmdp.org/cibmtrehrclientbackend/v2";
